      ...
      <div>
        <div className="card" style={{width: "18rem", height: "464px"}}>
          ...
          <div className="card-body">
            ...
            <p className="card-text news-desc" style={{marginBottom:"8px", height : "4.5rem"}}>{props.description}</p>
            <p className="card-text author-credit"><small className="text-muted">Published by {props.author} at {props.date}</small></p>
